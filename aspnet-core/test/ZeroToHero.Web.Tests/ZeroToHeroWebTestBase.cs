...
{
    public abstract class ZeroToHeroWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ZeroToHeroWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ZeroToHeroWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ZeroToHeroDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ZeroToHeroDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ZeroToHeroDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ZeroToHeroDbContext, Task<T>> func)
        {
            T result;
